...
/**
 * EntityQueryWhereGroup
 *
 * @author : wugz
 * @since : 2022/1/27
 */
public class EntityQueryWhereGroup<E> {
   ...
   * 构造函数
   */
  public EntityQueryWhereGroup(EntityQuery<E> entityQuery, EntityQueryWhereBuilder<E> entityQueryWhereBuilder, WhereGroup whereGroup) {
   ...
   * @return
   */
  public EntityQueryWhereGroup<E> and() {
   ...
   * @return
   */
  public EntityQueryWhereGroup<E> or() {
   ...
   * @param value
   */
  public <T> EntityQueryWhereGroup<E> gt(EntityGetter<T> getter, Object value) {
   ...
   * @param value
   */
  public <T> EntityQueryWhereGroup<E> gt(boolean condition, EntityGetter<T> getter, Object value) {
   ...
   * @param value
   */
  public <T> EntityQueryWhereGroup<E> ge(EntityGetter<T> getter, Object value) {
   ...
   * @param value
   */
  public <T> EntityQueryWhereGroup<E> ge(boolean condition, EntityGetter<T> getter, Object value) {
   ...
   * @param value
   */
  public <T> EntityQueryWhereGroup<E> lt(EntityGetter<T> getter, Object value) {
   ...
   * @param value
   */
  public <T> EntityQueryWhereGroup<E> lt(boolean condition, EntityGetter<T> getter, Object value) {
   ...
   * @param value
   */
  public <T> EntityQueryWhereGroup<E> le(EntityGetter<T> getter, Object value) {
   ...
   * @param value
   */
  public <T> EntityQueryWhereGroup<E> le(boolean condition, EntityGetter<T> getter, Object value) {
   ...
   * @param value
   */
  public <T> EntityQueryWhereGroup<E> eq(EntityGetter<T> getter, Object value) {
   ...
   * @param value
   */
  public <T> EntityQueryWhereGroup<E> eq(boolean condition, EntityGetter<T> getter, Object value) {
   ...
   * @param value
   */
  public <T> EntityQueryWhereGroup<E> neq(EntityGetter<T> getter, Object value) {
   ...
   * @param value
   */
  public <T> EntityQueryWhereGroup<E> neq(boolean condition, EntityGetter<T> getter, Object value) {
   ...
   * @param value
   */
  public <T> EntityQueryWhereGroup<E> like(EntityGetter<T> getter, Object value) {
   ...
   * @param value
   */
  public <T> EntityQueryWhereGroup<E> like(boolean condition, EntityGetter<T> getter, Object value) {
   ...
   * @param value
   */
  public <T> EntityQueryWhereGroup<E> leftLike(EntityGetter<T> getter, Object value) {
    return like(true, getter, "", value, "%");
  }
   ...
   * @param value
   */
  public <T> EntityQueryWhereGroup<E> leftLike(boolean condition, EntityGetter<T> getter, Object value) {
    return like(condition, getter, "", value, "%");
  }
   ...
   * @param value
   */
  public <T> EntityQueryWhereGroup<E> rightLike(EntityGetter<T> getter, Object value) {
    return like(true, getter, "%", value, "");
  }
   ...
   * @param value
   */
  public <T> EntityQueryWhereGroup<E> rightLike(boolean condition, EntityGetter<T> getter, Object value) {
    return like(condition, getter, "%", value, "");
  }
   ...
   * @return
   */
  private <T> EntityQueryWhereGroup<E> like(boolean condition, EntityGetter<T> getter, Object left, Object value, Object right) {
   ...
   * @return
   */
  public <T> EntityQueryWhereGroup<E> between(EntityGetter<T> getter, Object start, Object end) {
   ...
   * @return
   */
  public <T> EntityQueryWhereGroup<E> between(boolean condition, EntityGetter<T> getter, Object start, Object end) {
    if (condition && null != getter) {
      EntityPropertyOrMethodMeta propertyMeta = EntityUtils.getPropertyMetaFromGetter(getter);
      if (null != propertyMeta.getFieldName()) {
   ...
   * @return
   */
  public <T> EntityQueryWhereGroup<E> isNull(EntityGetter<T> getter) {
   ...
   * @return
   */
  public <T> EntityQueryWhereGroup<E> isNull(boolean condition, EntityGetter<T> getter) {
   ...
   * @return
   */
  public <T> EntityQueryWhereGroup<E> isNotNull(EntityGetter<T> getter) {
   ...
   * @return
   */
  public <T> EntityQueryWhereGroup<E> isNotNull(boolean condition, EntityGetter<T> getter) {
   ...
   * @return
   */
  private <T> EntityQueryWhereGroup<E> isNullOrNotNull(boolean condition, EntityGetter<T> getter, RelationalType relationalType) {
   ...
   * @param value
   */
  private <T> EntityQueryWhereGroup<E> relationalExpression(boolean condition, EntityGetter<T> getter, RelationalType relationalType, Object value) {
    if (condition && null != getter && null != relationalType) {
      EntityPropertyOrMethodMeta propertyMeta = EntityUtils.getPropertyMetaFromGetter(getter);
      if (null != propertyMeta.getFieldName()) {
        String propName = entityQuery.checkParameterName(propertyMeta.getPropertyName());
