package com.github.easycaptcha.impl;


import com.github.easycaptcha.AbstractChineseCaptcha;
import com.github.easycaptcha.utils.GifEncoder;
...
public class ChineseCaptchaGifCaptcha extends AbstractChineseCaptcha {

  public ChineseCaptchaGifCaptcha() {
  }

  public ChineseCaptchaGifCaptcha(int width, int height) {
    setWidth(width);
    setHeight(height);
  }

  public ChineseCaptchaGifCaptcha(int width, int height, int len) {
    this(width, height);
    setLen(len);
  }

  public ChineseCaptchaGifCaptcha(int width, int height, int len, Font font) {
