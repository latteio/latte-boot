...
/**
 * EmailCaptchaStrategy
 *
 * @author : wugz
 * @since : 2022/10/21
 */
public class EmailCaptchaStrategy extends UsernamePasswordCaptchaStrategy {
  /**
   * 构造函数
   */
  public EmailCaptchaStrategy(
  ...
  public CaptchaCode getCode(String principal) throws Exception {
    // TODO: 生成验证码并添加到缓存
    // TODO: 通过邮件将验证码发送给指定邮件(principal)
